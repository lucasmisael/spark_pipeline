...
if __name__ == "__main__":
    ...
    tweet = spark.read.json(
        "/Users/lucasmisael/Documents/pessoal/pdi/pipelinesAirflow/datalake/silver/twitter_aluraonline/tweet"
    )
    ...
    tweet.coalesce(1)\
        ...
        .mode("overwrite")\
        .json(
        "/Users/lucasmisael/Documents/pessoal/pdi/pipelinesAirflow/datalake/gold"
    )